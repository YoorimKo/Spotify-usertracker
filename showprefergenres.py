...
print("\nrecent_tracks_info.json에서 가장 많이 언급된 장르:")
...
if current_playing_genre in [genre for genre, _ in top_liked_genres]:
    ...
    print("\n현재 재생 중인 노래의 장르는 recent_tracks_info.json에서 가장 많이 언급된 장르 중 하나입니다.")
else:
    print("\n현재 재생 중인 노래의 장르는 liked_tracks_info.json 및 recent_tracks_info.json에서 가장 많이 언급된 장르 중 어디에도 속하지 않습니다.")
